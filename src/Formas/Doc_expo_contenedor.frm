...
Begin VB.Form doc_expo_contenedor 
   Caption         =   "Mantenimiento de contenedores"
   ClientHeight    =   7125
   ClientLeft      =   3345
   ClientTop       =   4125
   ClientWidth     =   10905
   Icon            =   "Doc_expo_contenedor.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   7125
      ...
      Begin VB.Frame Frame13 
         ...
         Begin VB.Frame Fra_pto_descarga 
            ...
            Begin VB.CommandButton Cmd_hlp_pto_emb 
               ...
               Height          =   300
               Left            =   1215
               Picture         =   "Doc_expo_contenedor.frx":030A
               Style           =   1  'Graphical
               TabIndex        =   5
               ToolTipText     =   "Buscar"
               Top             =   255
      ...
      Begin Threed.SSFrame fra_tipo_rol 
         ...
         Begin VB.Frame Frame2 
            ...
            Begin VB.Frame Fra_temp_almac 
               ...
               End
            End
            Begin VB.Frame Fra_temp_transp 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   1350
               ...
               Begin GTMaskNum.GTMaskNum GTM_temp_dur_trans 
                  ...
                  EndProperty
               End
               Begin VB.Label Lbl_temp_transp 
                  AutoSize        =   -1  'True
                  Caption         =   "Dur Transp. :"
                  ForeColor       =   &H00800000&
                  Height          =   195
            ...
            Begin VB.Frame Fra_temp_manip 
               ...
               End
            End
            Begin VB.Frame Fra_temp_min_almac 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   3810
               ...
               End
            End
            Begin VB.Frame Fra_temp_max_almac 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   5040
               ...
               End
            End
            Begin VB.Frame Fra_temp_min_transp 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   120
               ...
               End
            End
            Begin VB.Frame Fra_temp_max_transp 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   1350
               ...
               End
            End
            Begin VB.Frame Fra_temp_min_manip 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   2640
               ...
               End
            End
            Begin VB.Frame Fra_temp_max_manip 
               BorderStyle     =   0  'None
               Caption         =   "Frame1"
               Height          =   540
               Left            =   3870
   ...
   End
End
Attribute VB_Name = "doc_expo_contenedor"
...
Public Sub habilita(ByVal opc As Boolean)
   If opc Then
      If Lstr_opc = "M" Then
         ...
         Cmb_pto_descarga.Enabled = False
...
Private Sub Graba_trol()
   ...
   If Lstr_opc = "A" Then
     ...
     If reg.EOF Then
        sql = "INSERT INTO docu_cont_exp (cont_linea, cont_buque, cont_viaje, cont_puer_emb, cont_puer_des, cont_contenedor, cont_tam_equip, cont_condicion, cont_tara, cont_tipo_equip, cont_proved_equip, cont_estad_equip, cont_indic_llen_vac, cont_cond_contrato, cont_reg_serv_transp, cont_natu_carg, cont_peso, cont_tipo_bien, cont_sello1, cont_sello2, cont_sello3, cont_sello4, cont_temp_dur_almac, cont_temp_dur_trans, cont_temp_dur_manip, cont_temp_min_almac, cont_temp_max_almac, cont_temp_min_trans, cont_temp_max_trans, cont_temp_min_manip, cont_temp_max_manip)" & _
             " VALUES ('" & Trim$(Cmb_linea.BoundText) & "',  '" & Trim$(Cmb_buque.BoundText) & "', '" & Trim$(Cmb_viaje.BoundText) & "'," & _
                      "'" & Txt_pto_emb.Text & "',            '" & Cmb_pto_descarga.BoundText & "',      '" & Txt_contenedor.Text & "', " & _
   ...
   ElseIf Lstr_opc = "M" Then
      sql = "UPDATE docu_cont_exp       SET  cont_cond_contrato = '" & Cmb_cond_contrato.BoundText & "'," & _
   ...
   ElseIf Lstr_opc = "E" Then
        sql = "SELECT * FROM docu_bldet_exp " & _
...
If Lstr_opc = "A" Then
      ...
      Cmb_estad_equip.BoundText = Gstr_param.estado_equip_expo
      Cmb_indic_llen_vac.BoundText = Gstr_param.indic_llen_vac
      Cmb_tipo_equip.BoundText = Gstr_param.tipo_equipo
End If

' si es KHS se poner visible solamente dos de los frames de temperatura y se le cambia las etiquetas.
If Cmb_linea.BoundText = "KHS" Then
    Me.Fra_temp_almac.Visible = True
    Me.Fra_temp_transp.Visible = True
    Me.Fra_temp_manip.Visible = False
    Me.Fra_temp_max_almac.Visible = False
    Me.Fra_temp_max_manip.Visible = False
    Me.Fra_temp_max_transp.Visible = False
    Me.Fra_temp_min_almac.Visible = False
    Me.Fra_temp_min_manip.Visible = False
    Me.Fra_temp_min_transp.Visible = False
    Lbl_temp_almac.Caption = "Temp. Desde:"
    Lbl_temp_transp.Caption = "Temp. Hasta:"
Else
    Me.Fra_temp_almac.Visible = True
    Me.Fra_temp_manip.Visible = True
    Me.Fra_temp_max_almac.Visible = True
    Me.Fra_temp_max_manip.Visible = True
    Me.Fra_temp_max_transp.Visible = True
    Me.Fra_temp_min_almac.Visible = True
    Me.Fra_temp_min_manip.Visible = True
    Me.Fra_temp_min_transp.Visible = True
    Me.Fra_temp_transp.Visible = True
    Lbl_temp_almac.Caption = "Dur Almac:"
    Lbl_temp_transp.Caption = "Dur Transp. :"
End If
End If
End Sub
...
Private Sub Cmd_hlp_pto_emb_Click()
   Cmb_pto_descarga.BoundText = Ayuda("docu_puerto", "puer_codigo", "puer_descripcion", " puer_linea ='" & Cmb_linea.BoundText & "' and puer_status ='A' ", "Puerto de Descarga")
End Sub
...
Dim reg As New ADODB.Recordset
   If Not RDC_grid_dato.Recordset.EOF Then
        ...
        If Not reg.EOF Then
            ...
            Txt_pto_emb.Text = RDC_grid_dato.Recordset("pto_emb")
            Cmb_pto_descarga.BoundText = RDC_grid_dato.Recordset("pto_des")
            '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            ...
            Cmb_tipo_bien.BoundText = IIf(Not IsNull(reg("cont_tipo_bien")), reg("cont_tipo_bien"), "")
...
Dim sql As String
   ...
   sql = "Select cont_contenedor as Contenedor,buqu_descripcion as Buque, " & _
         ...
         " from docu_cont_exp,docu_buque Where "
   If Cmb_linea.MatchedWithList Then
       ...
       If Txt_pto_emb.Text <> "" Then
          sql = Trim$(sql) & " And cont_puer_emb = '" & Txt_pto_emb.Text & "'"
       End If
       If Cmb_pto_descarga.MatchedWithList Then
          sql = Trim$(sql) & " And cont_puer_des = '" & Cmb_pto_descarga.BoundText & "'"
       End If
   ...
   Else
       ...
       Else
          ...
          Else
             If Txt_pto_emb.Text <> "" Then
                sql = Trim$(sql) & " cont_puer_emb = '" & Txt_pto_emb.Text & "'"
                If Cmb_pto_descarga.MatchedWithList Then
                   sql = Trim$(sql) & " And cont_puer_des = '" & Cmb_pto_descarga.BoundText & "'"
                End If
                If Txt_contenedor.Text <> "" Then
             ...
             Else
                If Cmb_pto_descarga.MatchedWithList Then
                   sql = Trim$(sql) & " cont_puer_des = '" & Cmb_pto_descarga.BoundText & "'"
                   If Txt_contenedor.Text <> "" Then
                      sql = Trim$(sql) & " And cont_contenedor = '" & Txt_contenedor.Text & "'"
                   End If
                Else
