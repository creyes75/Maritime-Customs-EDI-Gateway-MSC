...
Begin VB.Form doc_copia_viaje 
   ...
   Begin Threed.SSCommand btn_sgte 
      ...
      _ExtentY        =   873
      _StockProps     =   78
      Picture         =   "doc_copia_viaje.frx":0000
   End
   Begin Threed.SSCommand btn_elim 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "doc_copia_viaje.frx":0452
   End
End
Attribute VB_Name = "doc_copia_viaje"
...
If Not reg2.EOF Then
   ...
   sql = "Insert Into docu_manifiesto select mani_linea, '" & buque_new & "', '" & viaje_new & "', " & _
   ...
   If Chk_borra_bl.Value = 1 Then
        ...
        Gcon_docu.Execute sql, no_cab_del
         ...
         sql = sql & "Delete From docu_MANIFIESTO "
        sql = sql & " WHERE mani_linea       ='" & linea & "'" & _
                "   and mani_buque       ='" & buque & "'" & _
                "   and mani_viaje       ='" & viaje & "'" '&
