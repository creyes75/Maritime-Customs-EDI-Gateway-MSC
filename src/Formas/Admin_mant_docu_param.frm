...
Begin VB.Form Admin_mant_docu_param 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Parámetros del Sistema de Documentos "
   ClientHeight    =   4095
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   9930
   ...
   End
End
Attribute VB_Name = "Admin_mant_docu_param"
...
'RDC_dato.ConnectionString = Gstr_conex_docu
   ...
   RDC_grid_dato.RecordSource = "Select PARA_LINEA as Linea, PARA_CODIGO as codigo, PARA_DESCRIPCION as descripcion, PARA_VALOR as valor from docu_parametro ORDER BY PARA_LINEA, PARA_CODIGO"
