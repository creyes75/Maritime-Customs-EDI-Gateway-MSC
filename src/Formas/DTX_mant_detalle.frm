...
Begin VB.Form DTX_mant_detalle 
   Caption         =   "Mantenimiento de Detalle"
   ClientHeight    =   3945
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   11070
   ...
   End
End
Attribute VB_Name = "DTX_mant_detalle"
...
On Error GoTo Errores
        ...
        dta_conversion.RecordSource = "Select * from dtx_detalle"
