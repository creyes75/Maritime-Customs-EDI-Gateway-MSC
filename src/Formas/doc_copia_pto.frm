...
Begin VB.Form doc_copia_pto 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Copia de Bl's por Puerto"
   ClientHeight    =   4275
   ClientLeft      =   4230
   ClientTop       =   2640
   ClientWidth     =   6060
   ...
   Begin Threed.SSCommand btn_sgte 
      ...
      _ExtentY        =   873
      _StockProps     =   78
      Picture         =   "doc_copia_pto.frx":0000
   End
   Begin Threed.SSCommand btn_elim 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "doc_copia_pto.frx":0452
   End
End
Attribute VB_Name = "doc_copia_pto"
...
If Not Cmb_buque.MatchedWithList Or Not Cmb_viaje.MatchedWithList Or _
   Not Cmb_pto_emb.MatchedWithList Then
...
If Not Cmb_buque_new.MatchedWithList Or Not Cmb_viaje_new.MatchedWithList Or _
   Not cmb_pto_emb_new.MatchedWithList Then
