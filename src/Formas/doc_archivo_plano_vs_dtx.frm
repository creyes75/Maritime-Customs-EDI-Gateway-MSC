...
Begin VB.Form doc_archivo_plano_vs_dtx 
   ...
   Begin FPSpread.vaSpread Spr_plano 
      ...
      EndProperty
      SpreadDesigner  =   "doc_archivo_plano_vs_dtx.frx":0000
   End
   Begin VB.CommandButton Cmd_buscar 
      Caption         =   "Consulta"
      Height          =   660
      Left            =   5565
      Picture         =   "doc_archivo_plano_vs_dtx.frx":00FD
      Style           =   1  'Graphical
      TabIndex        =   8
   ...
   Begin VB.CommandButton Cmd_salir 
      ...
      Height          =   660
      Left            =   7095
      Picture         =   "doc_archivo_plano_vs_dtx.frx":0407
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Salir"
      Top             =   150
   ...
   Begin VB.CommandButton Cmd_modificar 
      ...
      Height          =   660
      Left            =   6330
      Picture         =   "doc_archivo_plano_vs_dtx.frx":0711
      Style           =   1  'Graphical
      TabIndex        =   3
   ...
   End
End
Attribute VB_Name = "doc_archivo_plano_vs_dtx"
...
Do While Not EOF(x)
    ...
    Loop
     ' ********* busqueda del contenedor en los datos ya almacenados del dtx ********
    sql = "Select cont_contenedor, cont_sello1, cont_tam_equip " & _
          " buqu_codigo, buqu_descripcion, " & _
          " buqv_viaje , " & _
          " blcab_consig " & _
          " bldet_puer_emb, bldet_puer_des, bldet_emp_resp, bldet_cono_emb, bldet_bultos, bldet_embalaje " & _
          " from docu_blcab, docu_bldet, docu_cont, docu_buque_viaje, docu_buque"
    sql = sql & " Where "
    sql = sql & "            cont_contenedor   ='" & contenedor & "'"
    sql = sql & "            buqv_fecha_arribo>='" & GTD_date.Text & "'"
    sql = sql & "        and cont_linea     = bldet_linea " & _
                     ...
                     "   and bldet_linea    = buqv_linea " & _
                     "   and bldet_buque    = buqv_buque " & _
                     "   and bldet_viaje    = buqv_viaje " & _
                     "   and buqv_linea     = buqu_linea " & _
                     "   and buqv_buque     = buqu_codigo" & _
    ...
    reg.Open sql, Gcon_docu, adOpenDynamic, adLockOptimistic
        If Not reg.EOF Then
            Do While Not reg.EOF
                ...
                ' falta incluir los datos del plano en el display del SPR
                'Call muestra_datos_spr(buqu_codigo, buqu_descripcion, buqv_viaje, bldet_puer_emb, bldet_puer_des, bldet_emp_resp, bldet_cono_emb, blcab_consig, bldet_secuencia, bldet_bultos, bldet_embalaje, cont_contenedor, cont_tam_equip, cont_sello1)
                reg.MoveNext
            Loop
        Else
            Spr_plano.MaxRows = Spr_plano.MaxRows + 1
...
'Spr_plano.Col = 1: Spr_plano.Text = "Cod Buque"
'  Spr_plano.Col = 2: Spr_plano.Text = "Nom Buque"
'  Spr_plano.Col = 3: Spr_plano.Text = "Viaje"
'  Spr_plano.Col = 4: Spr_plano.Text = "Puerto Emb"
'  Spr_plano.Col = 5: Spr_plano.Text = "Puerto_Desc"
'  Spr_plano.Col = 6: Spr_plano.Text = "Empresa Resp" 'oculto talvez
'  Spr_plano.Col = 7: Spr_plano.Text = "Bl"
'  Spr_plano.Col = 8: Spr_plano.Text = "Consignatario"
'  Spr_plano.Col = 9: Spr_plano.Text = "Secuencia" 'oculto
'  Spr_plano.Col = 10: Spr_plano.Text = "Bultos"
'  Spr_plano.Col = 11: Spr_plano.Text = "Embalaje"
'  Spr_plano.Col = 12: Spr_plano.Text = "Contenedor"
'
...
Public Sub Carga_Cabecera()
  ...
  Spr_plano.Col = 13: Spr_plano.Text = "Status"
  Spr_plano.Col = 14: Spr_plano.Text = "Tipo Contenedor"
  Spr_plano.Col = 15: Spr_plano.Text = "Puerto Emb"
  Spr_plano.Col = 16: Spr_plano.Text = "Puerto Desc"
  Spr_plano.Col = 17: Spr_plano.Text = "Puerot Final"
