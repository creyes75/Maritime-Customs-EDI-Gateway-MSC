...
Begin VB.Form doc_expo_bl 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Bill of lading de Exportación"
   ClientHeight    =   7650
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   10425
   ...
   Begin TabDlg.SSTab STab_bl 
      ...
      TabPicture(0)   =   "Doc_expo_bl.frx":1A8A
      ...
      TabPicture(1)   =   "Doc_expo_bl.frx":1AA6
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "Frame10"
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Fletes"
      TabPicture(2)   =   "Doc_expo_bl.frx":1AC2
      Tab(2).ControlEnabled=   0   'False
      Tab(2).Control(0)=   "Fra_flete_gral"
      Tab(2).Control(1)=   "Fra_flete_det"
      Tab(2).ControlCount=   2
      TabCaption(3)   =   "Detalle de Bl"
      TabPicture(3)   =   "Doc_expo_bl.frx":1ADE
      Tab(3).ControlEnabled=   0   'False
      Tab(3).Control(0)=   "Lbl_no_det_act"
      Tab(3).Control(1)=   "Lbl_no_det_tot"
      Tab(3).Control(2)=   "Label47"
      Tab(3).Control(3)=   "Frame29"
      Tab(3).Control(4)=   "Cmd_nuevo_det"
      Tab(3).Control(5)=   "Cmd_eliminar_det"
      Tab(3).Control(6)=   "Cmd_primer_det"
      Tab(3).Control(7)=   "Cmd_anterior_det"
      Tab(3).Control(8)=   "Cmd_siguiente_det"
      Tab(3).Control(9)=   "Cmd_ultimo_det"
      ...
      Begin VB.Frame Frame29 
         ...
         Begin VB.Frame Fra_IMO_KHS 
            ...
            Visible         =   0   'False
            Width           =   3375
            Begin VB.TextBox Txt_IMDG_page 
               Height          =   285
               Left            =   2370
               MaxLength       =   7
               TabIndex        =   68
               ...
               Width           =   855
            End
            Begin VB.TextBox Txt_UN_number 
               Height          =   285
               Left            =   1410
               MaxLength       =   4
               TabIndex        =   67
...
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).embalaje = Cmb_embalaje.BoundText
End Sub
...
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).Imo = Cmb_IMO.BoundText
End Sub
...
Carga_cabecera_fletes Cmb_linea.BoundText
carga_parametros Cmb_linea.BoundText

Txt_pto_emb.Text = Gstr_param.pto_descarga    'ECGYE
Txt_pto_origen.Text = Gstr_param.pto_descarga 'ECGYE
Txt_pto_trasb.Text = ""
...
Me.Cmb_regimen_adua.BoundText = Gstr_param.regimen_adua_expo
...
If Cmb_linea.BoundText = "KHS" Then
    Fra_IMO.Visible = False
    Fra_IMO_ONU.Visible = False
    Fra_IMO_KHS.Visible = True
    STab_bl.TabEnabled(1) = False
    Fra_flete_det.Top = Fra_flete_gral.Top
    Fra_flete_gral.Visible = False
    
    Label16.Visible = False:    Cmb_tipo_id_consignatario.Visible = False
    Label3.Visible = False:     Txt_id_consignatario.Visible = False:   Cmd_hlp_consignatario.Visible = False
    Label7.Visible = False:     Txt_nac_consignatario.Visible = False:  Cmd_hlp_nac_consignatario.Visible = False
    Label18.Visible = False:    Cmb_tipo_id_notificador.Visible = False
    Label22.Visible = False:    Txt_id_notificador.Visible = False:     Cmd_hlp_notificador.Visible = False
    
    Fra_notificador2.Visible = False
    
    Label59.Visible = False:    Txt_just_cambio.Visible = False
Else
    Fra_IMO.Visible = True
    Fra_IMO_ONU.Visible = True
    Fra_IMO_KHS.Visible = False
    STab_bl.TabEnabled(1) = True
    Fra_flete_det.Top = 2985
    Fra_flete_gral.Visible = True
    
    Label16.Visible = True:    Cmb_tipo_id_consignatario.Visible = True
    Label3.Visible = True:     Txt_id_consignatario.Visible = True:   Cmd_hlp_consignatario.Visible = True
    Label7.Visible = True:     Txt_nac_consignatario.Visible = True:  Cmd_hlp_nac_consignatario.Visible = True
    Label18.Visible = True:    Cmb_tipo_id_notificador.Visible = True
    Label22.Visible = True:    Txt_id_notificador.Visible = True:     Cmd_hlp_notificador.Visible = True
    
    Fra_notificador2.Visible = True
    
    Label59.Visible = True:    Txt_just_cambio.Visible = True
End If
End Sub
...
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).pelig_ONU = Cmb_ONU.BoundText
End Sub
...
If Cmb_pto_descarga.MatchedWithList Then
   sql = "Select * from docu_manifiesto_exp " & _
              ...
              "   And mani_puer_des ='" & Cmb_pto_descarga.BoundText & "'"
        reg.Open sql, Gcon_docu, adOpenDynamic, adLockOptimistic
        If Not reg.EOF Then
           Txt_pto_emb.Text = reg("mani_puer_emb")
...
Private Sub Cmb_tipo_id_emb_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then SendKeys "{TAB}"
End Sub
...
Private Sub Txt_danger_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then SendKeys "{TAB}"
End Sub

Private Sub Txt_danger_LostFocus()
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).danger_cargo = Txt_danger.Text
End Sub
...
Private Sub Txt_IMDG_page_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then SendKeys "{TAB}"
End Sub

Private Sub Txt_IMDG_page_LostFocus()
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).IMDG_page = Txt_IMDG_page.Text
End Sub
...
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).tipo_carga = Cmb_tipo_carga.BoundText
End Sub
...
If MsgBox("Esta seguro que desea eliminar el bl " & txt_bl.Text, vbYesNo + vbQuestion) = vbYes Then
    If Elimina_bl_EXP(Cmb_linea.BoundText, Cmb_buque.BoundText, Cmb_viaje.BoundText, Txt_pto_emb.Text, Cmb_pto_descarga.BoundText, Cmb_oper_carga.BoundText, txt_bl.Text) Then
        inicia_controles
        limpia_detalle
     End If
End If
...
If Gstr_opc_bl = "A" Then
        sql = "Insert into docu_blcab_exp (blcab_linea,     blcab_buque,    blcab_viaje, " & _
         ...
         sql = sql & "VALUES ('" & Cmb_linea.BoundText & "',    '" & Cmb_buque.BoundText & "',       '" & Cmb_viaje.BoundText & "', " & _
                        "'" & Txt_pto_emb.Text & "',       '" & Cmb_pto_descarga.BoundText & "',     '" & Cmb_oper_carga.BoundText & "', " & _
...
Else
        sql = "UPDATE docu_blcab_exp SET blcab_emp_anav ='" & Cmb_nav_carga.BoundText & "', " & _
        ...
        sql = sql & "  Where blcab_linea       ='" & Cmb_linea.BoundText & "'" & _
                        ...
                        "   and blcab_puer_des ='" & Cmb_pto_descarga.BoundText & "'" & _
      ...
      sql = "Delete from docu_bldet_exp " & _
              "Where bldet_linea      ='" & Cmb_linea.BoundText & "'" & _
               ...
               "   and bldet_puer_des ='" & Cmb_pto_descarga.BoundText & "'" & _
        ...
        If mani_bl_det(i).elim <> "E" Then
          ...
          sql = "insert into docu_bldet_exp " & _
            " VALUES ('" & Cmb_linea.BoundText & "',    '" & Cmb_buque.BoundText & "',      '" & Cmb_viaje.BoundText & "', " & _
                  ...
                  "'" & Trim(mani_bl_det(i).marca_num) & "', '" & Trim(mani_bl_det(i).desc_carga) & "',  '" & Trim$(mani_bl_det(i).tipo_prod) & "', " & mani_bl_det(i).volumen & ", " & _
                  ...
                  "'" & Trim(mani_bl_det(i).tipo_equip) & "','" & Trim(mani_bl_det(i).cond_cont) & "',   '" & Trim(mani_bl_det(i).danger_cargo) & "'," & _
                  "'" & Trim(mani_bl_det(i).UN_number) & "', '" & Trim(mani_bl_det(i).IMDG_page) & "')"

            Gcon_docu.Execute sql
        End If
    Next i
End If
Call actualiza_totales_manifiesto_expo(Cmb_linea.BoundText, Cmb_buque.BoundText, Cmb_viaje.BoundText, Txt_pto_emb.Text, Cmb_pto_descarga.BoundText, Cmb_oper_carga.BoundText)
' ------ seccion de fletes ------
 sql = "Delete from docu_blflete_exp " & _
              "Where flete_linea      ='" & Cmb_linea.BoundText & "'" & _
               ...
               "   and flete_puer_des ='" & Cmb_pto_descarga.BoundText & "'" & _
...
Private Sub Cmd_hlp_cont_Click()
     Txt_contenedor.Text = Ayuda("docu_cont_exp", "cont_contenedor", "cont_tam_equip", " cont_linea ='" & Cmb_linea.BoundText & "' and cont_buque ='" & Cmb_buque.BoundText & "' and cont_viaje ='" & Cmb_viaje.BoundText & "' and cont_puer_emb ='" & Txt_pto_emb.Text & "' and cont_puer_des ='" & Cmb_pto_descarga.BoundText & "'", "Contenedor")
End Sub
...
On Error GoTo ERROR_VALIDA
   ...
   If Trim$(Txt_pto_origen.Text) = "" Then
      ...
      Exit Function
   End If
   If Trim$(Cmb_pto_descarga.BoundText) = "" Then
      MsgBox "Ingrese el Código del puerto de descarga", vbInformation, App.Title
      valida_Datos = False
      If Cmb_pto_descarga.Enabled Then Cmb_pto_descarga.SetFocus
      Exit Function
   End If
...
'      Exit Function
'   End If
   If Trim$(Txt_id_consignatario.Text) = "" And Cmb_linea.BoundText <> "KHS" Then
   ...
   If Trim$(Txt_nombre_embarcador.Text) = "" Then
      ...
      valida_Datos = False
      If Txt_nombre_embarcador.Enabled Then Txt_nombre_embarcador.SetFocus
      Exit Function
   End If
...
Private Sub Form_Load()
    ' debido a un cambio en la ADUANA el  campo consignatario debe contener en realidad los datos del embarcador
    Me.Top = 0
    Me.Left = 0
...
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).desc_carga = Txt_desc_carga.Text
End Sub
...
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).just_cambio = Txt_just_cambio.Text
End Sub

Private Sub Txt_marcas_LostFocus()
If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).marca_num = Txt_marcas.Text
End Sub
...
Private Sub muestra_detalle()
    ...
    'para KHS unicamente
    Txt_danger.Text = Trim(mani_bl_det(CDbl(Lbl_no_det_act.Caption)).danger_cargo)
    Txt_UN_number.Text = Trim(mani_bl_det(CDbl(Lbl_no_det_act.Caption)).UN_number)
    Txt_IMDG_page.Text = Trim(mani_bl_det(CDbl(Lbl_no_det_act.Caption)).IMDG_page)
End Sub
...
Public Sub habilita_detalle(opc As Boolean)
    ...
    Txt_danger.Enabled = opc
    Txt_UN_number.Enabled = opc
    Txt_IMDG_page.Enabled = opc
...
Public Sub carga_bl(linea As String, buque As String, viaje As String, _
    ...
    If Not reg.EOF Then
        ...
        Cmb_pto_descarga.BoundText = reg("blcab_puer_des")
        ...
        Do While Not REG_det.EOF
            ...
            mani_bl_det(i).danger_cargo = IIf(Not IsNull(REG_det("bldet_danger_cargo")), REG_det("bldet_danger_cargo"), "")
            mani_bl_det(i).UN_number = IIf(Not IsNull(REG_det("bldet_UN_number")), REG_det("bldet_UN_number"), "")
            mani_bl_det(i).IMDG_page = IIf(Not IsNull(REG_det("bldet_IMDG_page")), REG_det("bldet_IMDG_page"), "")
            REG_det.MoveNext
            i = i + 1
        Loop
        If i > 1 Then
        ...
        Do While Not REG_flete.EOF
            ...
            If Cmb_linea.BoundText = "KHS" Then
                ...
                Grid_flete.Col = 5:  Grid_flete.Text = IIf(Not IsNull(REG_flete("flete_por")), REG_flete("flete_por"), "")
...
mani_bl_det(i).danger_cargo = ""
mani_bl_det(i).UN_number = ""
mani_bl_det(i).IMDG_page = ""
End Sub
...
sql = "Select * from docu_cont_exp " & _
               ...
               "   and cont_puer_des ='" & Cmb_pto_descarga.BoundText & "'" & _
...
Else
    ...
    frm_cont.Cmb_pto_descarga.BoundText = Cmb_pto_descarga.BoundText
    frm_cont.Txt_pto_emb.Text = Txt_pto_emb.Text
...
Private Sub cmb_pto_descarga_KeyPress(KeyAscii As Integer)
KeyAscii = Asc(UCase(Chr(KeyAscii)))
If KeyAscii = 13 Then SendKeys "{TAB}"
End Sub
...
On Error GoTo Errores
    ...
    For i = 1 To Grid_flete.Rows - 2
        ...
        sql = "Insert into docu_blflete_exp values(" & _
              ...
              "'" & Cmb_pto_descarga.BoundText & "','" & Cmb_oper_carga.BoundText & "', " & _
              "'" & txt_bl.Text & "'," & i & ","
...
Private Sub Txt_UN_number_KeyPress(KeyAscii As Integer)
If KeyAscii = 13 Then SendKeys "{TAB}"
End Sub

Private Sub Txt_UN_number_LostFocus()
    If Lbl_no_det_act.Caption <> "0" Then mani_bl_det(CDbl(Lbl_no_det_act.Caption)).UN_number = Txt_UN_number.Text
End Sub
