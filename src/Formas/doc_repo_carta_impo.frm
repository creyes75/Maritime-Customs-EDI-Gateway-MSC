...
Begin VB.Form doc_repo_carta_impo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Carta de  Importacion"
   ClientHeight    =   2370
   ClientLeft      =   45
   ClientTop       =   1830
   ClientWidth     =   5070
   Icon            =   "doc_repo_carta_impo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ...
   Begin VB.CommandButton Cmd_plantilla 
      Height          =   615
      Left            =   120
      Picture         =   "doc_repo_carta_impo.frx":0ECA
      Style           =   1  'Graphical
      TabIndex        =   9
   ...
   Begin VB.CommandButton Cmd_procesar 
      Height          =   615
      Left            =   3720
      Picture         =   "doc_repo_carta_impo.frx":11D4
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   1680
      Width           =   615
   ...
   Begin VB.CommandButton Cmd_cancel 
      Height          =   615
      Left            =   4380
      Picture         =   "doc_repo_carta_impo.frx":14DE
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   1680
      Width           =   615
   ...
   End
End
Attribute VB_Name = "doc_repo_carta_impo"
...
On Error GoTo fin
    ...
    doc_plantilla = App.Path + "\Plantillas\" + "CartaImport.doc"
...
Private Sub Cmd_procesar_Click()
    ...
    doc_plantilla = Ruta + "CartaImport.doc"
...
oWord.Selection.TypeText Text:=" "
    ...
    If Dir(Gstr_Ruta_BlWord & Trim(Cmb_buque.Text), vbDirectory) = "" Then MkDir (Gstr_Ruta_BlWord & Trim(Cmb_buque.Text))
    If Dir(Gstr_Ruta_BlWord & Trim(Cmb_buque.Text) & "\" & Trim(Cmb_viaje.Text), vbDirectory) = "" Then MkDir (Gstr_Ruta_BlWord & Trim(Cmb_buque.Text) & "\" & Trim(Cmb_viaje.Text))
    NomArchivo = Gstr_Ruta_BlWord & Trim(Cmb_buque.Text) & "\" & Trim(Cmb_viaje.Text) & "\" & "Carta_import.doc"
    If Dir(NomArchivo, vbArchive) <> "" Then Kill (NomArchivo)
