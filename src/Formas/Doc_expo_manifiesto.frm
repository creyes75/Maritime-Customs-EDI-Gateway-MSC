...
Begin VB.Form doc_expo_manifiesto 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mantenimiento de Manifiesto de Exportación"
   ClientHeight    =   5040
   ClientLeft      =   3330
   ClientTop       =   4110
   ClientWidth     =   8715
   Icon            =   "Doc_expo_manifiesto.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   5040
   ...
   Begin TabDlg.SSTab Tab_dato 
      ...
      TabPicture(0)   =   "Doc_expo_manifiesto.frx":030A
      ...
      TabPicture(1)   =   "Doc_expo_manifiesto.frx":0326
      ...
      Begin VB.Frame Frame4 
         ...
         Begin VB.Frame Frame5 
            ...
            Begin VB.CommandButton Cmd_busc_hlp_pto_emb 
               ...
               Height          =   300
               Left            =   1140
               Picture         =   "Doc_expo_manifiesto.frx":0342
               Style           =   1  'Graphical
               TabIndex        =   60
               ToolTipText     =   "Buscar"
               Top             =   255
         ...
         Begin VB.CommandButton Cmd_buscar 
            Height          =   465
            Left            =   7605
            Picture         =   "Doc_expo_manifiesto.frx":0874
            Style           =   1  'Graphical
            TabIndex        =   55
            ToolTipText     =   "Filtrar"
            Top             =   180
      ...
      Begin Threed.SSFrame fra_tipo_rol 
         ...
         Begin VB.Frame Frame3 
            ...
            Begin VB.CommandButton Cmd_hlp_pto_inicio 
               ...
               Height          =   300
               Left            =   1140
               Picture         =   "Doc_expo_manifiesto.frx":0B7E
               Style           =   1  'Graphical
               TabIndex        =   16
               ToolTipText     =   "Buscar"
               Top             =   240
         ...
         Begin VB.Frame Fra_pto_emb 
            ...
            Begin VB.CommandButton Cmd_hlp_pto_emb 
               ...
               Height          =   300
               Left            =   1140
               Picture         =   "Doc_expo_manifiesto.frx":10B0
               Style           =   1  'Graphical
               TabIndex        =   4
               ToolTipText     =   "Buscar"
               Top             =   255
         ...
         Begin VB.Frame Fra_pto_descarga 
            ...
            Begin VB.CommandButton Cmd_hlp_pto_descarga 
               ...
               Height          =   300
               Left            =   1140
               Picture         =   "Doc_expo_manifiesto.frx":15E2
               Style           =   1  'Graphical
               TabIndex        =   6
               ToolTipText     =   "Buscar"
               Top             =   255
   ...
   End
End
Attribute VB_Name = "doc_expo_manifiesto"
...
Private Sub Graba_trol()
   ...
   '''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
   If Lstr_opc = "A" Then
     sql = "Select * from docu_manifiesto_exp Where mani_linea = '" & Cmb_linea.BoundText & "' and mani_buque = '" & Cmb_buque.BoundText & "' and mani_viaje = '" & Cmb_viaje.BoundText & "' and mani_puer_emb ='" & Txt_pto_emb.Text & "' and mani_puer_des ='" & Txt_pto_descarga.Text & "'"
     reg.Open sql, Gcon_docu, adOpenDynamic, adLockOptimistic
     If reg.EOF Then
        sql = "INSERT INTO docu_manifiesto_exp (mani_linea,         mani_buque,         mani_viaje, " & _
   ...
   ElseIf Lstr_opc = "M" Then
      sql = "UPDATE docu_manifiesto_exp SET mani_adua_ing = '" & cmb_adua_ing.BoundText & "', " & _
   ...
   ElseIf Lstr_opc = "E" Then
      ...
      If resp Then resp = Elimina_manifiesto_exp(Cmb_linea.BoundText, Cmb_buque.BoundText, Cmb_viaje.BoundText, Txt_pto_emb.Text, Txt_pto_descarga.Text)
   End If
   If Lstr_opc <> "E" Then
...
If Cmb_linea.MatchedWithList Then
   ...
   If Lstr_opc = "A" Then
      Txt_pto_emb.Text = Gstr_param.pto_descarga ' GYE
      cmb_adua_ing.BoundText = Gstr_param.adua_ing
      Txt_tipo_mani.Text = Gstr_param.tipo_manif_expo
      ...
      Txt_pto_inicio.Text = Txt_pto_emb.Text 'Txt_pto_descarga.Text
      
   End If
   If Cmb_linea.BoundText = "KHS" Then
        Fra_orden.Visible = False
        Msk_manifiesto.Visible = False
        Label1(11).Visible = False
   Else
        Fra_orden.Visible = True
        Msk_manifiesto.Visible = True
...
If Me.Txt_busc_pto_emb.Text <> "" Then sql = sql & " pto_descarga like '" & Txt_busc_pto_emb.Text & "*'"
...
Public Sub Txt_pto_descarga_LostFocus()
    If Txt_pto_descarga.Text <> "" Then
        If Codigo_equivalente("docu_puerto", Txt_pto_descarga.Text, "puer_codigo", "puer_codigo") = "NO" Then
           If Txt_pto_descarga.Enabled Then Txt_pto_descarga.SetFocus
           ...
           Exit Sub
        End If
        'If Lstr_opc = "A" Then Txt_pto_inicio.Text = Txt_pto_descarga.Text
    End If
    ...
    If (Not Cmb_linea.MatchedWithList Or Not Me.Cmb_buque.MatchedWithList Or _
       Not Cmb_viaje.MatchedWithList Or Trim$(Txt_pto_descarga.Text) = "") And Lstr_opc = "C" Then
       limpia
       Cmd_modificar.Enabled = False
       cmd_eliminar.Enabled = False
       RDC_dato.Enabled = False
