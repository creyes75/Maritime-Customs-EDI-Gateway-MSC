...
Begin VB.Form doc_aux_busq_bl_expo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Búsqueda por Bl o Contendor de Exportación"
   ClientHeight    =   4500
   ClientLeft      =   45
   ClientTop       =   1830
   ClientWidth     =   5385
   Icon            =   "doc_aux_busq_bl_expo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   4500
   ...
   Begin VB.CommandButton Cmd_modificar 
      ...
      Height          =   660
      Left            =   4440
      Picture         =   "doc_aux_busq_bl_expo.frx":1CFA
      Style           =   1  'Graphical
      TabIndex        =   11
   ...
   Begin VB.CommandButton Cmd_Imprimir 
      ...
      Height          =   660
      Left            =   4440
      Picture         =   "doc_aux_busq_bl_expo.frx":213C
      Style           =   1  'Graphical
      TabIndex        =   10
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Cmd_cancel 
         ...
         Height          =   645
         Left            =   4410
         Picture         =   "doc_aux_busq_bl_expo.frx":223E
         Style           =   1  'Graphical
         TabIndex        =   8
         ToolTipText     =   "Salir"
         Top             =   1440
      ...
      Begin VB.CommandButton Cmd_busq 
         ...
         Height          =   645
         Left            =   4410
         Picture         =   "doc_aux_busq_bl_expo.frx":2548
         Style           =   1  'Graphical
         TabIndex        =   9
         ToolTipText     =   "Buscar"
         Top             =   720
   ...
   End
End
Attribute VB_Name = "doc_aux_busq_bl_expo"
...
Private Sub Cmd_busq_Click()
            ...
            Me.MousePointer = 11
             ...
             Else 'If Trim(txt_bl.Text) = "" And Trim$(Txt_contenedor.Text) <> "" Then
                  sql = sql & " FROM docu_blcab_exp, docu_bldet_exp, docu_cont_exp " & _
...
Dim frm_bl_mod As New doc_expo_bl
...
If Not RDC_grid_bl.Recordset.EOF Then
    ...
    frm_bl_mod.Caption = "Bl Expo: " & RDC_grid_bl.Recordset("bl")
End If
