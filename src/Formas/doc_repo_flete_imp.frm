...
Begin VB.Form doc_repo_flete_impo 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Fletes de Importacion"
   ClientHeight    =   3435
   ClientLeft      =   45
   ClientTop       =   1830
   ClientWidth     =   4680
   ...
   Begin VB.CommandButton Command1 
      ...
      Height          =   645
      Left            =   3240
      Picture         =   "doc_repo_flete_imp.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   2760
      Width           =   645
   ...
   Begin VB.CommandButton Command2 
      ...
      Height          =   645
      Left            =   3915
      Picture         =   "doc_repo_flete_imp.frx":030A
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   2760
      Width           =   645
   ...
   End
End
Attribute VB_Name = "doc_repo_flete_impo"
   ...
   '*****************datos de la fecha de arribo *************************
    ...
    '**********************************************************************
      ...
      sql = "Select blcab_consig, puer_descripcion, blcab_cono_emb, blcab_flete, blcab_metod_pago, " & _
               ...
               " from docu_blcab, docu_bldet, docu_puerto, docu_cont " & _
               ...
               "   and blcab_puer_emb    = puer_codigo " & _
