...
Begin VB.Form doc_expo_copia_pto 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Copia de Bl's Exportación por Puerto"
   ClientHeight    =   4275
   ClientLeft      =   7425
   ClientTop       =   3375
   ClientWidth     =   6060
   ...
   Begin Threed.SSCommand btn_sgte 
      ...
      _ExtentY        =   873
      _StockProps     =   78
      Picture         =   "doc_copia_pto_expo.frx":0000
   End
   Begin Threed.SSCommand btn_elim 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "doc_copia_pto_expo.frx":0452
   End
End
Attribute VB_Name = "doc_expo_copia_pto"
...
'Procedimiento:  Copia de Bl de un Puerto a otro
'Fecha        :  Viernes 19 de Marzo 2004
'Proceso      :  Validar que la linea,buque,viaje,puerto no exista ya en la tabla
...
If Not Cmb_buque.MatchedWithList Or Not Cmb_viaje.MatchedWithList Or _
   Not Cmb_pto_des.MatchedWithList Then
...
If Not Cmb_buque_new.MatchedWithList Or Not Cmb_viaje_new.MatchedWithList Or _
   Not cmb_pto_des_new.MatchedWithList Then
...
If Not reg2.EOF Then
 ...
 sql = "insert into docu_blflete_exp " & _
         "SELECT flete_linea,   '" & buque_new & "', '" & viaje_new & "', " & _
               ...
               " flete_cono_emb ,    flete_secuencia,     flete_cargo, " & _
   ...
   sql = sql + " and flete_puer_emb = '" & puerto & "'"
   ...
   If Chk_borra_bl.Value = 1 Then
        sql = "Delete " & _
                    ...
                    "           " ')" '& _
                    "   and cont_contenedor not in (" & _
                    "       Select bldet_contenedor_expo FROM docu_bldet_exp " & _
                    "       WHERE bldet_linea      = '" & linea & "'" & _
                    "           and bldet_buque    = '" & buque & "'" & _
                    "           and bldet_viaje    = '" & viaje & "'" & _
                    "           and bldet_puer_des = '" & puerto & "'" & _
        ...
        Call actualiza_totales_manifiesto_expo(Cmb_linea.BoundText, Cmb_buque.BoundText, Cmb_viaje.BoundText, Cmb_pto_des.BoundText, puerto_emb, reg2("blcab_emp_resp"))
...
carga_datacombo Me.data_pto_des, Cmb_pto_des, sql, "mani_puer_des", "mani_puer_des"
...
Private Sub Cmb_viaje_new_Change()
   ...
   carga_datacombo Me.data_pto_des_new, cmb_pto_des_new, sql, "mani_puer_des", "mani_puer_des"
End Sub
