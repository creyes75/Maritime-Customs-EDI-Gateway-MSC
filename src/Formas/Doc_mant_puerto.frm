...
Begin VB.Form doc_mant_puerto 
   ...
   Begin TabDlg.SSTab Tab_dato 
      ...
      Begin Threed.SSFrame fra_tipo_rol 
         ...
         EndProperty
         Begin VB.TextBox Txt_codigo_KHS 
            Height          =   285
            Left            =   1575
            MaxLength       =   1
            TabIndex        =   11
...
'   End If
   ...
   If Lstr_opc = "A" Then
     sql = "SELECT puer_codigo FROM docu_puerto WHERE puer_linea ='" & Cmb_linea.BoundText & "' and  puer_codigo = '" & txt_codigo.Text & "'"
     'Set REG = gcon_docu.OpenRecordset(sql, rdOpenKeyset)
     reg.Open sql, Gcon_docu, adOpenDynamic, adLockOptimistic
     If reg.EOF Then
        sql = "INSERT INTO docu_puerto (puer_linea, puer_codigo, puer_descripcion, puer_status)" & _
   ...
   ElseIf Lstr_opc = "M" Then
      sql = "UPDATE docu_puerto SET puer_descripcion = '" & Trim$(txt_desc.Text) & "', " & _
                               "puer_status   = '" & Txt_codigo_KHS.Text & "' " & _
...
If Cmb_linea.MatchedWithList Then
   ...
   RDC_grid_dato.RecordSource = "Select puer_codigo as codigo, puer_descripcion as descripcion, puer_status as Status from docu_puerto Where puer_linea = '" & Cmb_linea.BoundText & "'"
...
On Error GoTo errores
    ...
    CReport.SelectionFormula = "{docu_puerto.puer_status}='A'"
...
Me.MousePointer = 11
If ColIndex = 0 Then
   RDC_grid_dato.RecordSource = "Select puer_codigo as codigo, puer_descripcion as descripcion, puer_status as Status from docu_puerto where puer_linea ='" & Cmb_linea.BoundText & "' ORDER BY puer_codigo"
ElseIf ColIndex = 1 Then
   RDC_grid_dato.RecordSource = "Select puer_codigo as codigo, puer_descripcion as descripcion, puer_status as Status from docu_puerto where puer_linea ='" & Cmb_linea.BoundText & "' ORDER BY puer_descripcion"
End If
RDC_grid_dato.Refresh
Grid_dato.Refresh
Me.MousePointer = 0
