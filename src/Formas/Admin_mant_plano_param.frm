...
Begin VB.Form Admin_mant_plano_param 
   ...
   End
End
Attribute VB_Name = "Admin_mant_plano_param"
...
'RDC_dato.ConnectionString = Gstr_conex_docu
   ...
   RDC_grid_dato.RecordSource = "Select PARA_LINEA_PROC as Linea, PARA_LINEA as formato_file, PARA_CODIGO as codigo, PARA_DESCRIPCION as descripcion, PARA_VALOR as valor from plano_parametro ORDER BY PARA_LINEA_PROC, PARA_LINEA, PARA_CODIGO"
