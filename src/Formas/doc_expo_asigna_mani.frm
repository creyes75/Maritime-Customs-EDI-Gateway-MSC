...
Begin VB.Form doc_expo_asigna_mani 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Asigna Manifiesto CAE Exportación"
   ClientHeight    =   2685
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4860
   ...
   Begin VB.CommandButton Cmd_acep 
      ...
      Height          =   510
      Left            =   3690
      Picture         =   "doc_expo_asigna_mani.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   1
      ToolTipText     =   "Aceptar"
      Top             =   2100
   ...
   Begin VB.CommandButton Cmd_canc 
      Height          =   510
      Left            =   4275
      Picture         =   "doc_expo_asigna_mani.frx":0282
      Style           =   1  'Graphical
      TabIndex        =   0
   ...
   End
End
Attribute VB_Name = "doc_expo_asigna_mani"
...
On Error GoTo Errores
    ...
    If Len(Trim$(Msk_manifiesto.Text)) = 14 Then
       ...
       End If
       sql = "UPDATE docu_manifiesto_exp SET mani_adua_ing = '" & adua_ing & "', " & _
