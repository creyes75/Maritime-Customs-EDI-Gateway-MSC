...
Begin VB.Form doc_repo_expo_cont 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Contenedores de Exportacion"
   ClientHeight    =   3660
   ClientLeft      =   45
   ClientTop       =   1830
   ClientWidth     =   4680
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Cmb_tamano 
         Height          =   315
         ItemData        =   "doc_repo_cont_expo.frx":0000
         Left            =   2760
         List            =   "doc_repo_cont_expo.frx":000D
   ...
   Begin Threed.SSCommand Command1 
      ...
      EndProperty
      Font3D          =   3
      Picture         =   "doc_repo_cont_expo.frx":0020
   End
   Begin Threed.SSCommand command2 
      ...
      EndProperty
      Font3D          =   3
      Picture         =   "doc_repo_cont_expo.frx":033A
   End
End
Attribute VB_Name = "doc_repo_expo_cont"
...
Private Sub Command1_Click()
    ...
    DoEvents
    Me.MousePointer = 11
    If Opt_cont.Value Then Call LISTADO_EXCEL_CONT Else Call LISTADO_EXCEL_CONT_BL
    Me.MousePointer = 0
...
Me.MousePointer = 11
   ...
   sht_est.Cells(2, 5).Value = "Listado de Contenedores de Exportación"
   ...
   sht_est.Cells(9, 7).Borders.LineStyle = 1
      ...
      'If Dir(Grabar.filename) <> "" Then
       ...
       NomArchivo = Gstr_Ruta_BlWord & Trim(Cmb_buque.Text) & "\" & Trim(Cmb_viaje.Text) & "\" & "ContExpo.XLS"
...
Me.MousePointer = 11
   ...
   sht_est.Cells(9, 8).Borders.LineStyle = 1
      ...
      sql = "Select * " & _
               " from docu_bldet_exp, docu_cont_exp " & _
               " Where cont_linea       ='" & Cmb_linea.BoundText & "'" & _
               "   and cont_buque       ='" & Cmb_buque.BoundText & "'" & _
