...
Begin VB.Form doc_mant_esta_equip 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mantenimiento de Estado de Equipamiento"
   ClientHeight    =   3870
   ClientLeft      =   3360
   ClientTop       =   4110
   ClientWidth     =   6480
   Icon            =   "doc_mant_esta_equip.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ScaleHeight     =   3870
   ...
   Begin TabDlg.SSTab Tab_dato 
      ...
      TabPicture(0)   =   "doc_mant_esta_equip.frx":030A
      ...
      TabPicture(1)   =   "doc_mant_esta_equip.frx":0326
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.CommandButton Cmd_buscar 
            Height          =   465
            Left            =   5085
            Picture         =   "doc_mant_esta_equip.frx":0342
            Style           =   1  'Graphical
            TabIndex        =   15
            Top             =   195
            Width           =   465
      ...
      Begin Threed.SSFrame fra_tipo_rol 
         ...
         _ExtentY        =   3678
         _StockProps     =   14
         Caption         =   " Datos de Estado de Equipamiento "
         ForeColor       =   128
   ...
   End
End
Attribute VB_Name = "doc_mant_esta_equip"
...
Private Sub Graba_trol()
   ...
   If Lstr_opc = "A" Then
     ...
     If reg.EOF Then
        sql = "INSERT INTO docu_cond_contenedor (cond_cont_linea, cond_cont_codigo, cond_cont_descripcion)" & _
...
'    CReport.WindowTitle = App.Title
    'CReport.Action = 1
    Call Excel_repo_mant("estado_equipo")
    Exit Sub
Errores:
    MsgBox "Ocurrio el error " & Err.Description, vbInformation, App.Title
End Sub
